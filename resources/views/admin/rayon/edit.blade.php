        ...
        <div class="d-flex align-items-center mb-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.rayons.index') }}" class="text-secondary text-decoration-none">Data Rayon</a></li>
                    <li class="breadcrumb-item active text-dark fw-semibold">Tambah Data rayon</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card shadow border-0 mx-auto" style="max-width: 800px;">
            ...
            <div class="card-header bg-primary text-white py-4">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="card-title mb-0">Update Data Rayon</h4>
                        <small class="opacity-75">Isi form berikut untuk menambahkan Rayon baru</small>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-5">
                ...
                <form action="{{ route('admin.rayons.update',$rayon->id) }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    @method ('PUT')
                    <div class="row">
                        <!-- Nama Jurusan -->
                        <div class="col-md-12 mb-4">
                            <label for="nama_rayon" class="form-label fw-semibold">
                                <i class="fas fa-book me-2 text-primary"></i>Nama Rayon
                            </label>
                            ...
                            <small class="form-text text-muted mt-1">
                                Contoh: Cisarua,Ciawi,Cicurug,Cibedug,Tajur,Wikrama
                            </small>
                        </div>

                        <!-- Kode Jurusan -->
                        <div class="col-md-12 mb-4">
                            <label for="pembimbing" class="form-label fw-semibold">
                                <i class="fas fa-code me-2 text-primary"></i>Nama pembimbing
                            </label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('pembimbing', $rayon->pembimbing ??'') }}"
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="{{ route('admin.rayons.index') }}" class="btn btn-outline-secondary">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const namaRayon = document.getElementById('nama_rayon');
        if (namaRayon) {
            namaRayon.addEventListener('blur', function() {
        ...
        if (pembimbing) {
            pembimbing.addEventListener('input', function() {

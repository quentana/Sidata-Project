                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h5 class="card-title mb-0 text-primary">
                            <i class="fas fa-graduation-cap me-2"></i>Data Sampah Rombel
                        </h5>
                    </div>
                </div>
            </div>
                                    ...
                                    <td>
                                     ...
                                     <td class="d-flex align-items-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            <form action="{{ route('admin.rombles.restore', $item['id']) }}"
                                                method="POST">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit" class=" btn btn-success"> Kembalikan</button>
                                            </form>
                                            <form action="{{ route('admin.rombles.delete_permanent', $item['id']) }}"
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <small class="text-muted">
                                Menampilkan {{ $rombles->count() }} dari {{ $rombles->count() }} Rombel
                            </small>
                        </div>
                        <div class="col-md-6">

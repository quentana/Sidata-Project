        ...
        <div class="d-flex align-items-center mb-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.rombles.index') }}" class="text-secondary text-decoration-none">Data Romble</a></li>
                    <li class="breadcrumb-item active text-dark fw-semibold">Tambah Data Romble</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card shadow border-0 mx-auto" style="max-width: 800px;">
            ...
            <div class="card-header bg-primary text-white py-4">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="card-title mb-0">Tambah Data Romble</h4>
            ...
            <div class="card-body p-5">
                ...
                <form action="{{ route('admin.rombles.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <label for="nama_romble" class="form-label fw-semibold">
                                <i class="fas fa-book me-2 text-primary"></i>Nama Romble
                            </label>
                            <div class="input-group">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('nama_romble') }}"
                                       placeholder="Masukkan nama Romble"
                                       required>
                                @error('nama_romble')
                        ...
                        <div class="col-md-12 mb-4">
                            <label for="tingkat" class="form-label fw-semibold">
                                <i class="fas fa-code me-2 text-primary"></i>Kelas Tingkat
                            </label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const namaromble = document.getElementById('nama_rombel');
        if (namaromble) {

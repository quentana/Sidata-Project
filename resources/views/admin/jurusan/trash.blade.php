            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="card-title mb-0 text-primary">
                        <i class="fas fa-graduation-cap me-2"></i>Data Sampah  Jurusan
                    </h5>
                </div>
            </div>
        </div>
                            ...
                            <tr>
                               ...
                               <td class="d-flex align-items-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            <form action="{{ route('admin.jurusans.restore', $item['id']) }}"
                                                method="POST">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit" class=" btn btn-success"> Kembalikan</button>
                                            </form>
                                            <form action="{{ route('admin.jurusans.delete_permanent', $item['id']) }}"

            ...
            <div class="col-md-10 col-lg-8">
                <div class="login-card">
                    ...
                    <div class="card-header-section">
                        ...
                        <h3 class="login-title">Login SMK Wikrama</h3>
...
<style>
    ...
    /* Card Login - LEBAR KE SAMPING TAPI RENDAH */
    .login-card {
        background: white;
        border-radius: 20px;
        ...
        /* Lebar maksimal diperbesar, tinggi dikurangi */
        max-width: 800px;
        margin: 0 auto;
        width: 100%;
    ...
    /* Header Card - Padding dikurangi vertikal */
    .card-header-section {
    ...
    /* Body Card - Padding dikurangi vertikal */
    .card-body-section {
        padding: 2rem 3rem;
    }

    /* Alert Custom - Ukuran dikurangi */
    ...
    /* Submit Button - Ukuran dikurangi */
    .submit-section {
        margin-bottom: 1.5rem;
    }
    ...
    /* Tambahan untuk layar sangat besar */
